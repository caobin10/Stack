...
//	private TextView footerTextView;
	public static TextView footerTextView;
	...
	private void initView(Context context) {
		...
		//^^^
//		footerView.setBackgroundColor(Color.parseColor("#7ee4e4e4"));
		//^^^
		//设置布局 水平方向  
...
//		footerView.setGravity(Gravity.CENTER_HORIZONTAL);
		//^^
		footerView.setMinimumHeight(AbViewUtil.scaleValue(mContext,100));//Minimum:最小
...
//		footerProgressBar = new ProgressBar(context,null,android.R.attr.progressBarStyle);
		...
		setFooterProgressBarDrawable(getResources().getDrawable(R.drawable.frame));
		//^^^
