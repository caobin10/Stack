...
public class SectionListView extends ListView {
    private GradientDrawable mShadowDrawable;//阴影(渐变)
    private int mShadowHeight;//阴影高度
...
//    public SectionListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//    }
    ...
    public static boolean isItemViewTypePinned(ListAdapter adapter, int viewType) {
        ...
        return ((SectionListAdapter) adapter).isItemViewTypePinned(viewType);
    }
    ...
    public static interface SectionListAdapter extends ListAdapter {
