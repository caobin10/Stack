...
public class SweetDialog extends Dialog {
    ...
    //^^^
    private static SweetDialog progressDialog;
    //^^^
...
//    public static SweetDialog createLoadingDefault(Context context)
//    {
//        progressDialog = new SweetDialog(context,R.style.ProgressHUD);
